...
const Content = React.forwardRef<HTMLElement, ContentProps>(function Content(
  ...
  return children ? (
    <SubframeCore.Select.Content asChild={true} {...otherProps}>
      <div
        className={SubframeCore.twClassNames(
          "flex w-full flex-col items-start overflow-hidden rounded-md border border-solid border-brand-50 bg-white px-1 py-1 shadow-lg",
          className
        )}
        ref={ref as any}
      >
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div
            className={SubframeCore.twClassNames(
              "flex h-8 w-full flex-none flex-col items-start rounded-md border border-solid border-brand-50 bg-default-background group-focus-within/bb88f90b:border group-focus-within/bb88f90b:border-solid group-focus-within/bb88f90b:border-brand-50",
              {
