...
/*
 * Documentation:
 * Text Area — https://app.subframe.com/f7606ea2a7a5/library?component=Text+Area_4ec05ee8-8f1c-46b2-b863-5419aa7f5cce
 */
  ...
  return (
    <textarea
      className={SubframeCore.twClassNames(
        "min-h-[96px] w-full border-none bg-transparent px-2 py-1.5 text-body font-body text-default-font outline-none",
        className
      )}
    ...
    return (
      ...
      >
        ...
        {children ? (
          <div
            className={SubframeCore.twClassNames(
              "flex w-full grow shrink-0 basis-0 flex-col items-start rounded-md border border-solid border-brand-50 bg-default-background px-1 group-focus-within/4ec05ee8:border group-focus-within/4ec05ee8:border-solid group-focus-within/4ec05ee8:border-brand-50",
              {
