...
/*
 * Documentation:
 * Table — https://app.subframe.com/f7606ea2a7a5/library?component=Table_142dfde7-d0cc-48a1-a04c-a08ab2252633
  ...
  return (
    <tr
      className={SubframeCore.twClassNames(
        "group/5d119f8d border-t border-solid border-brand-50",
...
const TableRoot = React.forwardRef<HTMLElement, TableRootProps>(
  function TableRoot(
    ...
    return (
      ...
      >
        <thead>{header}</thead>
        <tbody className="border-b border-solid border-brand-50">
          {children}
        </tbody>
      </table>
    );
